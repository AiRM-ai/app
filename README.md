...
**Please clone this repo and access the "AIRM- TUTORIAL and HOW-TO" and "AIRM_Workflow_Screenshots" documents to get a full, detailed guide on how to run, access, and use the AiRM software.**
